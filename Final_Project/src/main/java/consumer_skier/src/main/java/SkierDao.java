...
public class SkierDao {
    private Jedis jedis;
    private String TOTAL_VERTICAL = "TOTAL_VERTICAL";
    ...
    public void createSkier(LiftRide newLiftRide) {
        ...
        String field = resortID + "-" + seasonID + "-" + dayID + "-" + skierID;

        Pipeline pip = jedis.pipelined();
        pip.hincrBy(TOTAL_VERTICAL, field, vertical);
        pip.sync();
//        System.out.println("field: " + field + ", value: " + jedis.hget(TOTAL_VERTICAL, field));
    }
//
